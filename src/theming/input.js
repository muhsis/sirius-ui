...
export const inputBtnPaddingX = '.65rem'
export const inputSelectPaddingY = '.23rem'
...
export const inputSelectPaddingYLg = '.48rem'
export const inputSelectPaddingXLg = '1.5rem'
...
export const inputTotalPaddingY = '.75rem'
...
export const inputTotalPaddingYSm = '.3rem'
